...
public abstract class GameObject {
	...
	/*
	 * public String toStringDebug( ) { StringBuilder elem = new StringBuilder();
	 * 
	 * //this.getShortName(); elem.append(this.getShortName());
	 * elem.append(" [ l: "); elem.append(this.getResistance());
	 * elem.append(",x: "); elem.append(this.getX()); elem.append(",y; ");
	 * elem.append(this.getY()); elem.append(",t: ");
	 * elem.append(this.getRemainigCycles()); elem.append("]");
	 * 
	 * 
