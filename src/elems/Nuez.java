...
public class Nuez extends Plant {
	/*
	 * public Nuez(int x, int y, Game game) { super(x, y, game); inicializar(); }
	 * 
	 * public Nuez() { inicializar(); }
	 * 
	 * private void inicializar() { cost = 50; res = 10; cycles = 0; nameShort =
	 * "N"; name = "nuez"; infoName = "[N]uez"; }
	 */
