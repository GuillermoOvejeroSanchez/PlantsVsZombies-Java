...
public class Deportista extends Zombie {
	/*
	 * public Deportista(int x, int y, Game game) { super(x, y, game);
	 * inicializar(); }
	 * 
	 * public Deportista() { inicializar(); }
	 * 
	 * private void inicializar() { res = 2; cycles = 1; cyclesLeft = cycles; dmg =
	 * 1; nameShort = "D"; name = "deportista"; infoName = "[D]eportista"; }
	 */
