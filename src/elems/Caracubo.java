...
public class Caracubo extends Zombie {
	/*
	 * public Caracubo(int x, int y, Game game) { super(x, y, game); inicializar();
	 * }
	 * 
	 * public Caracubo() { inicializar(); }
	 * 
	 * private void inicializar() { res = 8; cycles = 4; cyclesLeft = cycles; dmg =
	 * 1; nameShort = "B"; name = "caracubo"; infoName = "[C]aracubo"; }
	 */
